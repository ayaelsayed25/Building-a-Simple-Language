...
public class Language implements LanguageConstants {
  ...
  static private boolean jj_3R_6() {
    if (jj_scan_token(LEFTBRAC)) return true;
  ...
  static private boolean jj_3R_3() {
    if (jj_scan_token(LEFTBRAC)) return true;
    if (jj_3R_5()) return true;
    if (jj_scan_token(EQUAL2)) return true;
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x200,0x130040,0xc00,0x4000c0,0x405000,};
   }
